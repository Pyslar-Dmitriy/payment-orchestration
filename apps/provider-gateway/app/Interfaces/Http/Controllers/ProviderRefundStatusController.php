...
use App\Application\Provider\QueryRefundStatusHandler;
...
final class ProviderRefundStatusController
{
    public function __construct(private readonly QueryRefundStatusHandler $handler) {}

    public function __invoke(Request $request, string $refundUuid): JsonResponse
    {
