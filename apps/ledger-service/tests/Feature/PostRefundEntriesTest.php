...
class PostRefundEntriesTest extends TestCase
{
    ...
    public function test_refund_posting_writes_outbox_message_with_correct_fields(): void
    {
        ...
        $this->assertSame('refund', $message->payload['posting_type']);
        $this->assertSame('merchant-abc', $message->payload['merchant_id']);
        $this->assertNotNull($message->payload['refund_id']);
